...
export default function AlumniCreateResourcePage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setTimeout(() => navigate('/dashboard/resources'), 1000);
    } catch (err) {
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-6 py-10">
        <button onClick={() => navigate('/dashboard/resources')} className="flex items-center gap-2 text-black mb-8 group">
