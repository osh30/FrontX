    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {!planner.courses || planner.courses.length === 0 ? (
            <div className="col-span-full p-12 text-center bg-white/40 backdrop-blur-xl rounded-3xl border border-dashed border-gray-200 shadow-sm">
              <BookOpen className="w-12 h-12 text-gray-300 mx-auto mb-4" />
              <p className="text-lg font-medium text-gray-900 mb-1">No courses added yet.</p>
              <p className="text-sm text-gray-500 mb-4">Add your courses to track study notes and outline progress.</p>
              <button onClick={() => setShowAddCourse(true)} className="px-5 py-2.5 bg-gray-900 text-white rounded-xl text-sm font-semibold hover:bg-indigo-600 transition-colors inline-flex items-center gap-2">
