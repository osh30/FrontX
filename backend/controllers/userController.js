  ...
  try {
    ...
    const REAL_RECRUITERS = [
      ...
      },
      {
        ...
        companyDescription: 'BRAC is a global development organization working to create opportunities for people living in poverty and to support sustainable social and economic development.',
      ...
      },
      {
        ...
        companyDescription: 'bKash is a leading mobile financial services company in Bangladesh providing digital financial services.',
    ...
    // Auto-seed ShopUp & 9 Opportunities if missing
    try {
      ...
      if (shopUpCount === 0) {
        ...
        if (typeof seedShopUpOpportunities === 'function') await seedShopUpOpportunities();
      }
    } catch (e) {}

    try {
      const bracCount = await Opportunity.countDocuments({ companyName: /BRAC/i });
      if (bracCount === 0) {
